        ...
        try {
            ...
            switch (reason) {
                case DownloadManager.ERROR_CANNOT_RESUME:
                    reasonText = com.android.internal.R.string.error_cannot_resume;
                    break;
                case DownloadManager.ERROR_DEVICE_NOT_FOUND:
                    reasonText = com.android.internal.R.string.error_device_not_found;
                    break;
                case DownloadManager.ERROR_FILE_ALREADY_EXISTS:
                    reasonText = com.android.internal.R.string.error_file_already_exists;
                    break;
                case DownloadManager.ERROR_FILE_ERROR:
                    reasonText = com.android.internal.R.string.error_file_error;
                    break;
                case DownloadManager.ERROR_HTTP_DATA_ERROR:
                    reasonText = com.android.internal.R.string.error_http_data_error;
                    break;
                case DownloadManager.ERROR_INSUFFICIENT_SPACE:
                    reasonText = com.android.internal.R.string.error_insufficient_space;
                    break;
                case DownloadManager.ERROR_TOO_MANY_REDIRECTS:
                    reasonText = com.android.internal.R.string.error_too_many_redirects;
                    break;
                case DownloadManager.ERROR_UNHANDLED_HTTP_CODE:
                    reasonText = com.android.internal.R.string.error_unhandled_http_code;
                    break;
                case DownloadManager.ERROR_UNKNOWN:
                default:
                    reasonText = com.android.internal.R.string.error_unknown;
                    break;
            }
