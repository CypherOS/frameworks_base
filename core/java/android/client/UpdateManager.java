 ...
 * @hide
 */
public abstract class UpdateManager implements Response.Listener<JSONObject>, Response.ErrorListener {
	...
	protected void initStartChecking() {
	...
	public class Client {
		...
		public List<UpdateInfo> createPackageInfoList(JSONObject response) throws Exception {
			...
			Collections.sort(list, new Comparator<UpdateInfo>() {
			    @Override
