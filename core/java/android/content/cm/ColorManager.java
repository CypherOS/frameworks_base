...
public class ColorManager {
     ...
     */
    public boolean updateTheme(String themePackage, int userId) {
        try {
            return mColorManager.updateTheme(themePackage, userId);
     ...
     */
    public boolean updateAccent(String accentPackage, int userId) {
        try {
            return mColorManager.updateAccent(accentPackage, userId);
        } catch (RemoteException e) {
            return false;
        }
    }
    ...
    /**
     * Removes all currently enabled accents and restores the default
     * system accent. This does not apply the base themes.
     * @return tries to return to the default accent, if unsuccessful return false
     */
    public boolean restoreDefaultAccent() {
        try {
            return mColorManager.restoreDefaultAccent();
        } catch (RemoteException e) {
            return false;
        }
    }
