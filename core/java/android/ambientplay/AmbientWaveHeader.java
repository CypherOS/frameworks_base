 ...
 * @hide
 */
public class AmbientWaveHeader {

    // follows WAVE format in http://ccrma.stanford.edu/courses/422/projects/WaveFormat

    private static final String TAG = "AmbientWaveHeader";
    ...
    /**
     * Construct a AmbientWaveHeader, with all fields defaulting to zero.
     */
    public AmbientWaveHeader() {
    }

    /**
     * Construct a AmbientWaveHeader, with fields initialized.
     ...
     */
    public AmbientWaveHeader(short format, short numChannels, int sampleRate, short bitsPerSample, int numBytes) {
        mFormat = format;
     ...
     * @param format
     * one of {@link #FORMAT_PCM}, {@link #FORMAT_ULAW}, or {@link #FORMAT_ALAW}.
     * @return reference to this AmbientWaveHeader instance.
     */
    public AmbientWaveHeader setFormat(short format) {
        mFormat = format;
        return this;
    }
     ...
     * @return reference to this AmbientWaveHeader instance.
     */
    public AmbientWaveHeader setNumChannels(short numChannels) {
        mNumChannels = numChannels;
        return this;
    }
     ...
     * @return reference to this AmbientWaveHeader instance.
     */
    public AmbientWaveHeader setSampleRate(int sampleRate) {
        mSampleRate = sampleRate;
        return this;
    }
     ...
     * @return reference to this AmbientWaveHeader instance.
     */
    public AmbientWaveHeader setBitsPerSample(short bitsPerSample) {
        mBitsPerSample = bitsPerSample;
        return this;
    }
     ...
     * @return reference to this AmbientWaveHeader instance.
     */
    public AmbientWaveHeader setNumBytes(int numBytes) {
        mNumBytes = numBytes;
        return this;
    }

    /**
     * Read and initialize a AmbientWaveHeader.
    ...
    public String toString() {
        return String.format(
                "AmbientWaveHeader format=%d numChannels=%d sampleRate=%d bitsPerSample=%d numBytes=%d",
