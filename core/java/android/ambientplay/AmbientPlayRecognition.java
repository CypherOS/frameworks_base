 ...
 */
public class AmbientPlayRecognition {

    private static final String TAG = "AmbientPlayRecognition";
    ...
    private class RecorderThread extends Thread {
        ...
        private String sendAudioData(byte[] inputBuffer, int length) {
            ...
            try {
                ...
                AmbientWaveHeader header = new AmbientWaveHeader(AmbientWaveHeader.FORMAT_PCM, CHANNELS,
    ...
    /**
     * Creates an AmbientPlayRecognition matching instances and allocates audio buffers
     */
    public AmbientPlayRecognition(@NonNull PrintCallback callback) {
        mCallback = callback;
