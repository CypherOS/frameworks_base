...
public class RecoginitionObserver {
    ...
    private static final String TAG = "RecoginitionObserver";
    ...
    public RecoginitionObserver(Context context) {
		...
		mManager = new AmbientIndicationManager.getInstance(context);
        ...
        private void parseXmlResult(String xml) {
            if (xml.contains("did not hear any music") || xml.contains("no close matches")) {
                ...
                if (match.find()) {
                    ...
                    observed.AlbumName = match.group(2);
                    observed.Song = match.group(3);
                    observed.AlbumImageUrl = match.group(4);
	...
	public static class Observable {
		...
		public String toString() {
			return Artist + " - " + Song + " (" + AlbumName + "); " + AlbumImageUrl;
		}
	}
