...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            if (navBarEnabled != mNavBarEnabled) {
                ...
                if (mHwManager != null) {
                    boolean isFingerprintNavigation = mHwManager.isSupported(DeviceHardwareManager.FEATURE_FINGERPRINT_NAVIGATION);
                    boolean canUse = mScreenOnFully && !mNavBarEnabled;
    ...
    public void systemReady() {
        ...
        boolean hasAlertSlider = mHwManager.isSupported(DeviceHardwareManager.FEATURE_ALERT_SLIDER);
        if (hasAlertSlider) {
            mHwManager.triStateReady(mContext);
        }
