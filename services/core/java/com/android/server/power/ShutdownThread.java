...
public final class ShutdownThread extends Thread {
    ...
    public static void rebootBootloader(final Context context, String reason, boolean confirm) {
        ...
        mRebootHasProgressBar = false;
        mReason = reason;
		mReason.equals(PowerManager.REBOOT_BOOTLOADER);
        shutdownInner(context, confirm);
    }
    ...
    public static void rebootRecovery(final Context context, String reason, boolean confirm) {
        ...
        mRebootHasProgressBar = false;
        mReason = reason;
		mReason.equals(PowerManager.REBOOT_RECOVERY)
        shutdownInner(context, confirm);
    }
    ...
    private static ProgressDialog showShutdownDialog(Context context) {
        ...
        } else if (mRebootRecovery && mReason.equals(PowerManager.REBOOT_RECOVERY)) {
			if (showSysuiReboot()) {
                return null;
            }
		...
		if (mRebootBootloader && mReason.equals(PowerManager.REBOOT_BOOTLOADER)) {
			if (showSysuiReboot()) {
                return null;
            }
    ...
    private static boolean showSysuiReboot() {
        ...
        try {
            ...
            if (service.showShutdownUi(mReboot, mRebootBootloader, mRebootRecovery, mReason)) {
