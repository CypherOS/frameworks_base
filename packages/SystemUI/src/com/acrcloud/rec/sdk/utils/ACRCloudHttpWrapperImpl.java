            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        out = out2;
                        try {
                            throw new ACRCloudException(ACRCloudException.HTTP_ERROR_TIMEOUT, e7.getMessage());
                        } catch (Throwable th4) {
                            if (out != null) {
                                try {
                                    out.flush();
                    ...
                    throw new ACRCloudException(ACRCloudException.HTTP_ERROR_TIMEOUT, e9.getMessage());
