...
public class KeyguardSecurityContainer extends FrameLayout implements KeyguardSecurityView {
    ...
    private Animation mFaceUnlockAnimationSet;
    ...
    public interface SecurityCallback {
        ...
        public void reset();
		public void tryToStartFaceUnlockFromBouncer();
    }
    ...
    public KeyguardSecurityContainer(Context context, AttributeSet attrs, int defStyle) {
		...
		mFaceUnlockAnimationSet = AnimationUtils.loadAnimation(mContext, R.anim.facelock_lock_blink);
    }
    ...
    public void updateSecurityIcon() {
        if (mSecurityIcon != null) {
            ...
            boolean isFaceUnlock = mUpdateMonitor.isFaceUnlockAvailable() || mUpdateMonitor.isFaceUnlockRecognizing();
                ...
                mSecurityIcon.setOnClickListener(new OnClickListener() {
                    public void onClick(View v) {
                        ...
                        if (mCallback != null) {
                            ...
                            mCallback.tryToStartFaceUnlockFromBouncer();
                        }
                    }
                });
	...
	private void updateIconAnimation() {
        if (mSecurityIcon != null && mFaceUnlockAnimationSet != null) {
            if (mUpdateMonitor.isFaceUnlockRecognizing()) {
                mFaceUnlockAnimationSet.setAnimationListener(new AnimationListener() {
					@Override
                    ...
                    public void onAnimationEnd(Animation animation) {
                        if (mUpdateMonitor.isFaceUnlockRecognizing() && mFaceUnlockAnimationSet != null && mSecurityIcon != null) {
                            Log.d(TAG, "start again");
                            mFaceUnlockAnimationSet.setAnimationListener(this);
                            mSecurityIcon.startAnimation(mFaceUnlockAnimationSet);
                        }
                    }
                });
                ...
                mFaceUnlockAnimationSet.setAnimationListener(null);
            }
        }
    }
    ...
    private KeyguardSecurityCallback mCallback = new KeyguardSecurityCallback() {
		...
		public void tryToStartFaceUnlockFromBouncer() {
            mSecurityCallback.tryToStartFaceUnlockFromBouncer();
        }
