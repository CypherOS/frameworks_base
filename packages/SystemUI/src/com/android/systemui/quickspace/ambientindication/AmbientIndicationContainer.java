...
public class AmbientIndicationContainer extends AutoReinflateContainer implements OnLayoutChangeListener,
    ...
    private static final String TAG = "AmbientIndicationContainer";
    ...
    private boolean mAllowedOnKeyguard;
    ...
    public void initializeView(StatusBar statusBar) {
        ...
        mAmbientPlayManager = new AmbientPlayManager(mContext, mStatusBar);
    ...
    private void updatePill() {
        ...
        if (mSong == null || mArtist == null || mNotificationsHidden || !mIsEnabled || !mAllowedOnKeyguard) {
    ...
    public void setAllowedOnKeyguard(boolean allowedOnKeyguard) {
        if (mAllowedOnKeyguard != allowedOnKeyguard) {
            mAllowedOnKeyguard = allowedOnKeyguard;
            if (mInitialized) {
                updatePill();
            }
        }
