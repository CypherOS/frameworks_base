...
public class AmbientIndicationContainer extends AutoReinflateContainer implements OnLayoutChangeListener, 
    ...
    private void updatePill() {
        ...
        mText.setText(mQuickspaceCard.getEventTitle());
        mAmbientIndication.setContentDescription(mQuickspaceCard.getEventTitle());
        ...
        if (TextUtils.isEmpty(mQuickspaceCard.getEventTitle()) || mNotificationsHidden) {
