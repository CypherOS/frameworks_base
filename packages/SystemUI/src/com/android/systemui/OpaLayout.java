...
import com.android.systemui.opa.HomeLongClickListener;
...
public class OpaLayout extends FrameLayout implements ButtonInterface {
    ...
    class RetractRunnable implements Runnable {
        ...
        public void run() {
            OpaLayout.cancelCurrentAnimation();
            OpaLayout.startRetractAnimation();
        }
    }
    ...
    class LongPressRunnable implements Runnable {
        ...
        public void run() {
            if (OpaLayout.mIsPressed) {
                OpaLayout.mLongClicked = true;
            }
        }
    }
    ...
    class LineListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animation) {
            OpaLayout.startCollapseAnimation();
        }
    ...
    public void setOnLongClickListener(OnLongClickListener l) {
        mHome.setOnLongClickListener(new HomeLongClickListener(this, l));
    }
