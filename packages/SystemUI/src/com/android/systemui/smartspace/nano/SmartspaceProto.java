...
public interface SmartspaceProto {
    ...
    public static final class CardWrapper extends MessageNano {
        public SmartspaceUpdate.SmartspaceCard mCard;
        ...
        public CardWrapper mergeFrom(CodedInputByteBufferNano input) throws IOException {
            while (true) {
                ...
                if (tag == 10) {
                    if (mCard == null) {
                        mCard = new SmartspaceUpdate.SmartspaceCard();
                    }
            ...
            public SmartspaceCard mergeFrom(CodedInputByteBufferNano input) throws IOException {
                while (true) {
                    ...
                    switch (tag) {
                        ...
                        case com.android.internal.R.drawable.edit_text:
                            if (tapAction == null) {
                                tapAction = new TapAction();
                            }
                            input.readMessage(tapAction);
                            break;
                        case com.android.internal.R.drawable.divider_horizontal_bright:
                            updateTimeMillis = input.readInt64();
                            break;
                        case 80:
                            eventTimeMillis = input.readInt64();
                            break;
                        case com.android.internal.R.style.Widget_DeviceDefault_RatingBar_Small:
                            eventDurationMillis = input.readInt64();
                            break;
                        case com.android.internal.R.attr.textAppearanceListItemSecondary:
                            if (expiryCriteria == null) {
                                expiryCriteria = new ExpiryCriteria();
                            }
                            input.readMessage(expiryCriteria);
                            break;
                        case com.android.internal.R.color.white:
                            value = input.readInt32();
                            switch (value) {
                                case 0:
                                case 1:
