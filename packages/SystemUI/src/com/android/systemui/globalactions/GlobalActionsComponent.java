...
public class GlobalActionsComponent extends SystemUI implements Callbacks, GlobalActionsManager {
    ...
    @Override
    public void handleShowShutdownUi(boolean isReboot, boolean isRebootBootloader,
                boolean isRebootRecovery, String reason) {
        mExtension.get().showShutdownUi(isReboot, isRebootBootloader, 
		        isRebootRecovery, reason);
    }
