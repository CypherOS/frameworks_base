...
public class GlobalActionsImpl implements GlobalActions {
    ...
    public void showShutdownUi(boolean isReboot, boolean isRebootBootloader,
		...
		if (isRebootBootloader) message.setText(R.string.global_restart_bootloader_message);
		if (isRebootRecovery) message.setText(R.string.global_restart_recovery_message);
