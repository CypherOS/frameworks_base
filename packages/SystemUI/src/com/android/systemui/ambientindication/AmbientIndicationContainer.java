...
import com.android.systemui.statusbar.AmbientStateController;
import com.android.systemui.statusbar.AmbientStateController.StateListener;
import com.android.systemui.statusbar.phone.StatusBar;
import com.android.systemui.util.wakelock.DelayedWakeLock;
import com.android.systemui.util.wakelock.WakeLock;

public class AmbientIndicationContainer extends AutoReinflateContainer implements OnClickListener, InflateListener, 
    OnLayoutChangeListener, StateListener, AnimatorUpdateListener {
    ...
    private void updatePill() {
        ...
        if (mAmbientMusicAnimation != null) {
            mAmbientMusicAnimation.setBounds(mAmbientIndicationIconSize, mAmbientIndicationIconSize);
        }
