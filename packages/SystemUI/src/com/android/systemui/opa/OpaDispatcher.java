...
public class OpaDispatcher {
    ...
    private void dispatchOpa(boolean enabled) {
        StatusBar bar = (StatusBar) SysUiServiceProvider.getComponent(mContext, StatusBar.class);
    ...
    private class OpaObserver extends ContentObserver {
        ...
        public void updateOpaStatus() {
            mOpaEnabled = Settings.System.getInt(mContext.getContentResolver(), Settings.System.OPA_ENABLED, 1) != 0;
