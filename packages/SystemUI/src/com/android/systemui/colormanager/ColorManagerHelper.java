...
public class ColorManagerHelper {
    ...
    public static void updateAccent(IOverlayManager om, IColorManager cm, Context context) throws RemoteException {
        ...
        switch (userAccentSetting) {
            case 0:
                restoreDefaultAccent(om);
                break;
            case 1:
                cm.updateAccent(ACCENT_DEEP_PURPLE);
                break;
            case 2:
                cm.updateAccent(ACCENT_INDIGO);
                break;
            case 3:
                cm.updateAccent(ACCENT_PINK);
                break;
            case 4:
                cm.updateAccent(ACCENT_PURPLE);
                break;
            case 5:
                cm.updateAccent(ACCENT_RED);
                break;
            case 6:
                cm.updateAccent(ACCENT_SKY_BLUE);
                break;
            case 7:
                cm.updateAccent(ACCENT_TEAL);
                break;
            case 8:
                cm.updateAccent(ACCENT_WHITE);
                break;
            case 9:
                cm.updateAccent(ACCENT_YELLOW);
                break;
        }
    }
}
