...
public class TaskViewHeader extends FrameLayout
    ...
    public TaskViewHeader(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mLightLockedDrawable = context.getDrawable(R.drawable.ic_recents_task_lock_animation_light);
        mLightUnlockedDrawable = context.getDrawable(R.drawable.ic_recents_task_unlock_animation_light);
        mDarkLockedDrawable = context.getDrawable(R.drawable.ic_recents_task_lock_animation_dark);
        mDarkUnlockedDrawable = context.getDrawable(R.drawable.ic_recents_task_unlock_animation_dark);
