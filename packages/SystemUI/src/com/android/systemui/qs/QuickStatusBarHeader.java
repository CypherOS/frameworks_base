...
import com.android.systemui.aoscp.privacy.IPrivacyChip;
import com.android.systemui.aoscp.privacy.OngoingPrivacyChip;
...
public class QuickStatusBarHeader extends RelativeLayout implements
        ...
        ZenModeController.Callback, IPrivacyChip {
	...
	private PrivacyChipController mPrivacyChipController;
    ...
    public QuickStatusBarHeader(Context context, AttributeSet attrs) {
		...
		mPrivacyChipController = PrivacyChipController.get(context);
    ...
    protected void onFinishInflate() {
		...
		mPrivacyChip = (OngoingPrivacyChip) findViewById(R.id.privacy_chip);
	...
	private void setChipVisibility(boolean isActive) {
        if (isActive) {
    ...
    public void setListening(boolean listening) {
        ...
        if (listening) {
			...
			mPrivacyChipController.addCallback(this);
        } else {
            mZenController.removeCallback(this);
            mAlarmController.removeCallback(this);
			mPrivacyChipController.removeCallback(this);
	...
	/*private void onChipClicked(Handler handler) {
        Dialog d = new OngoingPrivacyDialog(mContext, mPrivacyChip.getBuilder()).createDialog();
	...
	@Override
    public void onPrivacyChipChanged(int code, int uid, String packageName, boolean active) {
		mPrivacyChip.setChip(code, packageName, active);
		setChipVisibility(active);
	}
