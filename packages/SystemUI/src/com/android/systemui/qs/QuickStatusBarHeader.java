...
public class QuickStatusBarHeader extends RelativeLayout implements
	...
	/*private void onChipClicked(Handler handler) {
        Dialog d = new LiveOpsPrivacyDialog(mContext, mPrivacyChip.getOpCode(), mPrivacyChip.getOpPackage()).createDialog();
	...
	@Override
    public void onPrivacyChanged(List<LiveOpItem> activeOps) {
		mPrivacyChip.setChip(activeOps);
		setChipVisibility(activeOps.size() > 0);
	}
