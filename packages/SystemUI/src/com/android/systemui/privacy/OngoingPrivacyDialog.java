...
public final class OngoingPrivacyDialog {
    ...
    public OngoingPrivacyDialog(Context context, PrivacyDialogBuilder privacyDialogBuilder) {
		...
		mAppsAndTypes = CollectionsKt__CollectionsKt.sortedWith(mDialogBuilder.getAppsAndTypes(), 
		        ComparisonsKt__ComparisonsKt.compareBy(OngoingPrivacyTypeCamera.INSTANCE, OngoingPrivacyTypeMicrophone.INSTANCE, OngoingPrivacyTypeLocation.INSTANCE));
            ...
            if (items != null) {
                ...
                if (multiItems >= 0) {
                    for (int item = 0; item < MAX_ITEMS; item++) {
                        ...
                        addAppItem(items, (PrivacyApplication) pair.getFirst(), (List) pair.getSecond(), isMultiItems);
                        if (item == multiItems) {
                            break;
                        }
                    }
