...
public final class OngoingPrivacyDialog {
    ...
    public OngoingPrivacyDialog(Context context, PrivacyDialogBuilder privacyDialogBuilder) {
		...
		mAppsAndTypes = Collection.sortedWith(mDialogBuilder.getAppsAndTypes(), 
		        Comparator.compareBy(OngoingPrivacyTypeCamera.INSTANCE, OngoingPrivacyTypeMicrophone.INSTANCE, OngoingPrivacyTypeLocation.INSTANCE));
