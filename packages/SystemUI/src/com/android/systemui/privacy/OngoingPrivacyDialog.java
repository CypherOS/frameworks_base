...
public final class OngoingPrivacyDialog {
    ...
    public OngoingPrivacyDialog(Context context, PrivacyDialogBuilder privacyDialogBuilder) {
		...
		mAppsAndTypes = Collections.sortedWith(mDialogBuilder.getAppsAndTypes(), 
		        Comparisons.compareBy(OngoingPrivacyTypeCamera.INSTANCE, OngoingPrivacyTypeMicrophone.INSTANCE, OngoingPrivacyTypeLocation.INSTANCE));
