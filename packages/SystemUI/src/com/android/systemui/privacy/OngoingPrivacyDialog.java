...
public final class OngoingPrivacyDialog {
    ...
    public OngoingPrivacyDialog(Context context, PrivacyDialogBuilder privacyDialogBuilder) {
		...
		IComparisons[] types = new IComparisons[3];
        types[0] = OngoingPrivacyTypeCamera.INSTANCE;
        types[1] = OngoingPrivacyTypeMicrophone.INSTANCE;
		types[3] = OngoingPrivacyTypeLocation.INSTANCE;
		mAppsAndTypes = CollectionsKt.sortedWith(mDialogBuilder.getAppsAndTypes(), Comparisons.compareBy(types));
