...
public class PrivacyDialogBuilder {
    ...
    public PrivacyDialogBuilder(Context context, List<PrivacyItem> list) {
        ...
        mAppsAndTypes = CollectionsKt___CollectionsKt.sortedWith(toList, ComparisonsKt.compareBy(topRank));
        ...
        mTypes = CollectionsKt___CollectionsKt.sorted(CollectionsKt___CollectionsKt.distinct(privacyTypes));
    ...
    public List<Drawable> generateIconsForApp(List<? extends PrivacyType> list) {
        List<PrivacyType> sorted = CollectionsKt___CollectionsKt.sorted(list);
    ...
    private <T> StringBuilder joinWithAnd(List<? extends T> list) {
        ...
        CollectionsKt___CollectionsKt.joinTo(subList, sbAppend, mSeparator, null, null, 0, null, null, com.android.internal.R.styleable.windowNoTitle, null);
