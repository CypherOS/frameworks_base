...
import kotlin.collections.CollectionsKt.IterablesKt;
...
public class PrivacyDialogBuilder {
    ...
    private PrivacyApplication app;
    ...
    static final class SecondaryItemRank extends Lambda implements Function1<Pair<? extends PrivacyApplication, ? extends List<? extends PrivacyType>>, PrivacyType> {
        ...
        public PrivacyType invoke(Pair<PrivacyApplication, ? extends List<? extends PrivacyType>> pair) {
            return (PrivacyType) CollectionsKt.min((Iterable) pair.getSecond());
        }
    }
    ...
    public PrivacyDialogBuilder(Context context, List<PrivacyItem> list) {
        ...
        mAppsAndTypes = CollectionsKt.sortedWith(toList, ComparisonsKt.compareBy(topRank));
        ArrayList privacyTypes = new ArrayList(IterablesKt.collectionSizeOrDefault(list, 10));
		...
		app = mAppsAndTypes.size() != 1 ? null : (PrivacyApplication) ((Pair) mAppsAndTypes.get(0)).getFirst();
    }
    ...
    public List<Drawable> generateIconsForApp(List<? extends PrivacyType> list) {
        ...
        ArrayList generatedForApp = new ArrayList(IterablesKt.collectionSizeOrDefault(sorted, 10));
    ...
    public List<Drawable> generateIcons() {
        ArrayList generated = new ArrayList(IterablesKt.collectionSizeOrDefault(mTypes, 10));
    ...
    private <T> StringBuilder joinWithAnd(List<? extends T> list) {
        ...
        CollectionsKt.joinTo(subList, sbAppend, mSeparator, null, null, 0, null, null, com.android.internal.R.styleable.windowNoTitle, null);
    ...
    public String joinTypes() {
        ...
        if (mTypes.size() != 1) {
            ...
            ArrayList privacyName = new ArrayList(IterablesKt.collectionSizeOrDefault(list, 10));
