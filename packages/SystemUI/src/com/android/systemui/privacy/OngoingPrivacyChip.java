...
public final class OngoingPrivacyChip extends LinearLayout {
    ...
    public OngoingPrivacyChip(Context context, AttributeSet attributeSet, int res) {
        this(context, attributeSet, res, 0, 8, null);
    }

    public OngoingPrivacyChip(Context context, AttributeSet attributeSet, int i, int i2, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i3 & 2) != 0) {
            attributeSet = null;
        }
        if ((i3 & 4) != 0) {
    ...
    private void updateView() {
        ...
        if (mIconsContainer != null) {
            invoke(mBuilder, mIconsContainer);
            if (mText != null) {
	...
	public void invoke(PrivacyDialogBuilder dialogBuilder, ViewGroup container) {
        ...
        for (Drawable drawable : dialogBuilder.generateIcons()) {
            ...
            LayoutParams params = privacyIcon.getLayoutParams();
            if (params != null) {
