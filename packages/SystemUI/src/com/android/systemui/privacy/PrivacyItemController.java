...
public class PrivacyItemController implements Callback {
    ...
    private static final List<String> mIntents = CollectionsKt___CollectionsKt.listOf("android.intent.action.USER_FOREGROUND", "android.intent.action.MANAGED_PROFILE_ADDED", "android.intent.action.MANAGED_PROFILE_REMOVED");
    ...
    private List<Integer> mCurrentUserIds = CollectionsKt___CollectionsKt.emptyList();
    private boolean mListening;
    private final Runnable mNotifyChanges;
    private List<PrivacyItem> mPrivacyList = CollectionsKt___CollectionsKt.emptyList();
    ...
    public class Receiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (CollectionsKt___CollectionsKt.contains(mPrivacyItemController.mCompanion.getIntents(), intent != null ? intent.getAction() : null)) {
    ...
    private void update(boolean fromReceiver) {
        if (fromReceiver) {
            ...
            ArrayList ids = new ArrayList(CollectionsKt__IterablesKt.collectionSizeOrDefault(profiles, 10));
    ...
    private void updatePrivacyList() {
        ...
        for (Integer userIds : mCurrentUserIds) {
            CollectionsKt__MutableCollectionsKt.addAll(opItems, mAppOpsController.getActiveAppOpsForUser(userIds.intValue()));
        }
        ...
        mPrivacyList = CollectionsKt___CollectionsKt.distinct(list);
    }
