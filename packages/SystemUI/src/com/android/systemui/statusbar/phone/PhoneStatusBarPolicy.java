...
public class PhoneStatusBarPolicy implements Callback, Callbacks,
    ...
    public PhoneStatusBarPolicy(Context context, StatusBarIconController iconController) {
        ...
        mIconController.setIconVisibility(mSlotMicrophone, mLiveOpsController.getActiveOpCode() == AppOpsManager.OP_RECORD_AUDIO);

        // camera
        mIconController.setIcon(mSlotCamera, R.drawable.stat_sys_camera, null);
        mIconController.setIconVisibility(mSlotCamera, mLiveOpsController.getActiveOpCode() == AppOpsManager.OP_CAMERA);
    ...
    private final LiveOpsController.Callback mPrivacyCallback = new LiveOpsController.Callback() {
        ...
        public void onPrivacyChanged(int activeOps, int opCode, String opPackage) {
            mIconController.setIconVisibility(mSlotMicrophone, activeOps > 0 && opCode == AppOpsManager.OP_RECORD_AUDIO);
            mIconController.setIconVisibility(mSlotCamera, activeOps > 0 && opCode == AppOpsManager.OP_CAMERA);
        }
    };
