...
public class PhoneStatusBarPolicy implements Callback, Callbacks,
    ...
    public PhoneStatusBarPolicy(Context context, StatusBarIconController iconController) {
        ...
        mIconController.setIconVisibility(mSlotMicrophone, mPrivacyController.getActiveOpCode() == AppOpsManager.OP_RECORD_AUDIO);

        // camera
        mIconController.setIcon(mSlotCamera, R.drawable.stat_sys_camera, null);
        mIconController.setIconVisibility(mSlotCamera, mPrivacyController.getActiveOpCode() == AppOpsManager.OP_CAMERA);
