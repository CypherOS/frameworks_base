...
import com.android.systemui.aoscp.dialog.SnackShackDialogHelper;

/**
 * Snackshack view for use with OnTheSpot & SnackShackDialog.
 */
public class SnackShackDialogView extends RelativeLayout {

    /** Whether to output debugging information to logs. */
    private static final boolean DEBUG = SnackShackDialogHelper.DEBUG;
    /** Log output tag. */
    private static final String LOG_TAG = SnackShackDialogHelper.LOG_TAG;
    ...
    private View mInfoButton = null;

    /** Callback to call upon user choice. */
    private SnackShackDialogHelper.OnSettingChoiceListener mCallback = null;
     ...
     */
    public SnackShackDialogView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
        ...
        mDescription = (TextView) findViewById(R.id.dialog_description);

        mInfoButton = findViewById(R.id.action_dialog_info);
        mInfoButton.setOnClickListener(mButtonListener);
     ...
     * @param listener  {@link SnackShackDialogHelper.OnSettingChoiceListener} to notify
     *                  about the choice
    ...
    public void show(final String title, final String message,
            final SnackShackDialogHelper.OnSettingChoiceListener callback,
            Handler handler) {
		if (title == null) {
