...
package com.android.systemui.aoscp.feature;
...
/**
 * Snackshack view for use with OnTheSpot & SnackShackFeature.
 */
public class SnackShackFeatureView extends RelativeLayout {

    /** Whether to output debugging information to logs. */
    private static final boolean DEBUG = SnackShackFeatureHelper.DEBUG;
    /** Log output tag. */
    private static final String LOG_TAG = SnackShackFeatureHelper.LOG_TAG;
    ...
    private SnackShackFeatureHelper.OnSettingChoiceListener mCallback = null;
     ...
     */
    public SnackShackFeatureView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onFinishInflate() {
		...
		mTitle = (TextView) findViewById(R.id.feature_title);
        mDescription = (TextView) findViewById(R.id.feature_description);

        mConfirmButton = findViewById(R.id.action_feature_confirm);
        mConfirmButton.setOnClickListener(mButtonListener);
        mConfirmButton.setClickable(true);

        mDenyButton = findViewById(R.id.action_feature_deny);
     ...
     * @param listener  {@link SnackShackFeatureHelper.OnSettingChoiceListener} to notify
     *                  about the choice
    ...
    public void show(final String settingName, final String title, final String message,
            final SnackShackFeatureHelper.OnSettingChoiceListener callback,
            Handler handler) {
        if (settingName == null) {
