...
import com.android.systemui.aoscp.feature.SnackShackFeatureView;
 ...
 */
public final class SnackShackFeatureHelper {

    /** Whether to output debugging information to logs. */
    public static final boolean DEBUG = false;
    /** Log output tag. */
    public static final String LOG_TAG = "SnackShackFeature";
    ...
    private SnackShackFeatureHelper() {
    }
     ...
     * the callback.
     *
     * @param snackshack  {@link SnackShackFeatureView} being shown to the user
     ...
     */
    public static void prompt(final SnackShackFeatureView snackshack,
            final String settingName, final boolean defaultValue, final String title, final String message,
        ...
        switch (getSetting(resolver, settingName)) {
            ...
            default:
                ...
                snackshack.show(settingName, title, message, new OnSettingChoiceListener() {
