...
public class LiveOpsControllerImpl implements LiveOpsController, AppOpsManager.OnOpActiveChangedListener {
    ...
    private static final int[] LIVE_OPS = new int[] {AppOpsManager.OP_CAMERA,
    ...
    public LiveOpsControllerImpl(Context context) {
        ...
        mPackages = mAppOpsManager.getPackagesForOps(LIVE_OPS);
    }
    ...
    public void addCallback(Callback cb) {
        synchronized (mCallbacks) {
            if (mCallbacks.isEmpty()) {
                mAppOpsManager.startWatchingActive(LIVE_OPS, this);
