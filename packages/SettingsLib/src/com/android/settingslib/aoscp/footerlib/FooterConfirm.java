...
public class FooterConfirm extends FooterConfirmLayout {
	...
	private TextView mFooterAction;
	
    private int mOffset;
    private FooterActionClickListener mActionClickListener;
    private boolean mActionClicked;
    private FooterEventListener mEventListener;
    ...
    /**
     * Sets the confirmation message from a resource
     *
     * @param resId
     * @return
     */
    public FooterConfirm setMessage(@StringRes int resId) {
        return setMessage(getContext().getMessage(resId));
    }
    ...
    public FooterConfirm setActionTitle(@StringRes int resId) {
        return setActionTitle(getContext().getString(resId));
    }
     ...
     * @return
     */
    public FooterConfirm actionListener(FooterActionClickListener listener) {
     ...
     * @return
     */
    public FooterConfirm eventListener(FooterEventListener listener) {
    ...
    private MarginLayoutParams init(Context context, Activity targetActivity, ViewGroup parent) {
        ...
        mOffset = res.getDimensionPixelOffset(0dp);
        ...
        mFooterAction = (TextView) view.findViewById(R.id.action);
		if (mHasAction) {
			if (!TextUtils.isEmpty(mActionTitle)) {
				requestLayout();
				mFooterAction.setVisibility(VISIBLE);
				mFooterAction.setText(mActionTitle);
				mFooterAction.setOnClickListener(new OnClickListener() {
					@Override
				...
				mFooterAction.setVisibility(GONE);
			}
		}
    ...
    private void showInternal(Activity targetActivity, MarginLayoutParams params, ViewGroup parent) {
        ...
        Animation slideIn = AnimationUtils.loadAnimation(getContext(), R.anim.footer_confirm_bottom_in);
    ...
    private void dismiss(boolean animate) {
        ...
        final Animation slideOut = AnimationUtils.loadAnimation(getContext(), R.anim.footer_confirm_bottom_out);
